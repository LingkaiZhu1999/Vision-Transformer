...
def train(args):
	...
	if args.linear_probe:
		# Freeze the entire backbone; only the classifier head remains trainable
...
def parse_args():
	parser = argparse.ArgumentParser(description="Fine-tune pretrained ViT on CIFAR-100")
	...
	parser.add_argument("--save_path", type=str, default="vit_cifar100_finetuned.pt")
